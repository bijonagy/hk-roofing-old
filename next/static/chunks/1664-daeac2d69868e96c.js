    ...
    48418: function (e, t, o) {
      ...
      var b = u.default.forwardRef(function (e, t) {
          ...
          S = u.default.useMemo(
            function () {
              var e = n(l.resolveHref(w, r, !0), 2),
                t = e[0],
                o = e[1];
              return { href: t, as: b ? l.resolveHref(w, b) : o || t };
            },
            [w, r, b]
          ),
          U = S.href,
        ...
        var A = E ? I && "object" === typeof I && I.ref : t,
          D = n(s.useIntersection({ rootMargin: "200px" }), 3),
          H = D[0],
          K = D[1],
          G = D[2],
          q = u.default.useCallback(
            function (e) {
              (Z.current === B && N.current === U) ||
                (G(), (Z.current = B), (N.current = U)),
                H(e),
                A &&
                  ("function" === typeof A
                    ? A(e)
        ...
        if (!E || _ || ("a" === I.type && !("href" in I.props))) {
          var F = "undefined" !== typeof x ? x : w && w.locale,
            J =
              w &&
              w.isLocaleDomain &&
              d.getDomainLocale(B, F, w.locales, w.domainLocales);
          z.href = J || p.addBasePath(f.addLocale(B, F, w && w.defaultLocale));
        }
        return E
          ? u.default.cloneElement(I, z)
          : u.default.createElement("a", Object.assign({}, k, z), o);
      });
      (t.default = b),
        ("function" === typeof t.default ||
          ("object" === typeof t.default && null !== t.default)) &&
